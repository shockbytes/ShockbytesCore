...
abstract class BaseFragment<T: ShockbytesInjector> : Fragment() {
     ...
     * @ColorRes
     */
    abstract val snackBarForegroundColorRes: Int

    /**
     * @ColorRes
     */
    abstract val snackBarBackgroundColorRes: Int
    ...
    protected fun showSnackbar(text: String,
                               ...
                               @ColorRes fgColor: Int = snackBarForegroundColorRes,
                               @ColorRes bgColor: Int = snackBarBackgroundColorRes) {
        view?.let { v ->
